...
public class IdeaController : ControllerBase
{
    ...
    public async Task<IActionResult> ViewIdeas(int groupId)
    {
        ...
        {
            ideaDataToReturn.Add(new {idea.Id, idea.Title, idea.Description, idea.UserId, idea.Group.Name, idea.CreatedAt, idea.IsPromotedToProject, idea.IsDeleted, Status = idea.Status.ToString()});
        }
