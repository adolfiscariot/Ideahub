...
namespace Ideahub.Migrations
{
    public partial class InitialBaseline : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(name: "IX_Users_DisplayName", table: "Users", column: "DisplayName");
            ...
            migrationBuilder.CreateIndex(name: "IX_Groups_CreatedByUserId", table: "Groups", column: "CreatedByUserId");
            migrationBuilder.CreateIndex(name: "IX_Groups_IsActive", table: "Groups", column: "IsActive");
            migrationBuilder.CreateIndex(name: "IX_Groups_IsDeleted", table: "Groups", column: "IsDeleted");
            migrationBuilder.CreateIndex(name: "IX_Groups_Name", table: "Groups", column: "Name");
            migrationBuilder.CreateIndex(name: "IX_GroupMembershipRequests_GroupId", table: "GroupMembershipRequests", column: "GroupId");
            migrationBuilder.CreateIndex(name: "IX_GroupMembershipRequests_UserId", table: "GroupMembershipRequests", column: "UserId");
            migrationBuilder.CreateIndex(name: "IX_Ideas_GroupId", table: "Ideas", column: "GroupId");
            migrationBuilder.CreateIndex(name: "IX_Ideas_IsDeleted", table: "Ideas", column: "IsDeleted");
            migrationBuilder.CreateIndex(name: "IX_Ideas_Status", table: "Ideas", column: "Status");
            migrationBuilder.CreateIndex(name: "IX_Ideas_Title", table: "Ideas", column: "Title");
            migrationBuilder.CreateIndex(name: "IX_Ideas_UserId", table: "Ideas", column: "UserId");
            migrationBuilder.CreateIndex(name: "IX_UserGroups_GroupId", table: "UserGroups", column: "GroupId");
            migrationBuilder.CreateIndex(name: "IX_UserGroups_UserId", table: "UserGroups", column: "UserId");
            ...
            migrationBuilder.CreateIndex(name: "IX_Projects_GroupId", table: "Projects", column: "GroupId");
            migrationBuilder.CreateIndex(name: "IX_Projects_IdeaId", table: "Projects", column: "IdeaId");
            migrationBuilder.CreateIndex(name: "IX_Projects_IsDeleted", table: "Projects", column: "IsDeleted");
            migrationBuilder.CreateIndex(name: "IX_Projects_OverseenByUserId", table: "Projects", column: "OverseenByUserId");
            migrationBuilder.CreateIndex(name: "IX_Projects_Status", table: "Projects", column: "Status");
            migrationBuilder.CreateIndex(name: "IX_Projects_Title", table: "Projects", column: "Title");
            migrationBuilder.CreateIndex(name: "IX_Votes_IdeaId", table: "Votes", column: "IdeaId");
            migrationBuilder.CreateIndex(name: "IX_Votes_UserId_IdeaId", table: "Votes", columns: new[] { "UserId", "IdeaId" }, unique: true);
        }
