...
export class CommentsService {
  ...
  getComments(ideaId: number): Observable<ApiResponse<viewComment[]>> {
    return this.http
      .get<
        ApiResponse<viewComment[]>
      >(`${this.apiUrl}/view-comments?ideaId=${ideaId}`)
      .pipe(map((response) => this.convertResponse<viewComment[]>(response)));
  }
  ...
  ): Observable<ApiResponse<viewComment>> {
    return this.http
      .post<
        ApiResponse<viewComment>
      >(`${this.apiUrl}/create-comment?ideaId=${ideaId}`, newComment)
      .pipe(map((response) => this.convertResponse<viewComment>(response)));
  }
  ...
  deleteComment(commentId: number): Observable<ApiResponse<void>> {
    return this.http
      .delete<ApiResponse<void>>(`${this.apiUrl}/${commentId}`)
