    ...
    @if (authService.passwordSetupRequired$ | async) {
      <div class="nag-banner">
        <div class="banner-content">
          <p>
            🔒 <strong>Secure your access:</strong> You're currently signed in
            via the Intranet. Set a password to ensure you can login to IdeaHub
            independently, using the password you set and your Intranet email.
          </p>
